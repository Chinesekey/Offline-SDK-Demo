...
//        bubbleContainer.setTranslationY(popupInfo.offsetY);
    ...
    public void doAttach() {
        ...
        if (popupInfo.touchPoint != null) {
            ...
            //假设下方放不下，超出window高度
            boolean isTallerThanWindowHeight = ((getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y) + getPopupContentView().getMeasuredHeight()) > maxY;
            if (isTallerThanWindowHeight) {
                isShowUp = (getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y)  > XPopupUtils.getScreenHeight(getContext()) / 2;
            } else {
                isShowUp = false;
            }
            ...
            int maxHeight = (int) (isShowUpToTarget() ? ((getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y)  - XPopupUtils.getStatusBarHeight() - overflow)
                    : (XPopupUtils.getScreenHeight(getContext()) - (getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y)  - overflow));
            ...
            getPopupContentView().post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (isShowUpToTarget()) {
                        ...
                        translationY = (getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y)  - getPopupContentView().getMeasuredHeight() - defaultOffsetY;
                    } else {
                        translationY = (getPopupContentView().getMeasuredHeight() - popupInfo.touchPoint.y)  + defaultOffsetY;
                    }
                    //设置气泡相关
                    if(isShowUpToTarget()){
            ...
            //假设下方放不下，超出window高度
            boolean isTallerThanWindowHeight = (rect.top + getPopupContentView().getMeasuredHeight()) > maxY/2;
//            Log.e("test",maxY+"---->>>"+rect.top );
//            Log.e("test",maxY+"---->>>"+ getPopupContentView().getMeasuredHeight());
...
//            if (!isCreated) {
                ...
                int maxHeight = isShowUpToTarget() ? (rect.top - XPopupUtils.getStatusBarHeight() - overflow)
                        : (XPopupUtils.getScreenHeight(getContext()) - rect.top - overflow);
