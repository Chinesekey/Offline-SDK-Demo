...
//        setTranslationY(0);
    ...
    public OnViewClickedListener listener;

    public CenterPopupView setOnViewClickedListener(OnViewClickedListener listener){
        this.listener = listener;
        return this;
    }

    public interface OnViewClickedListener{
        void onConfirm(BasePopupView popupView, View view);
        void onDismiss();
    }
}
